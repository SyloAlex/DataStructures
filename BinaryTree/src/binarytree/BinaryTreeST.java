...
public class BinaryTreeST {
    ...
    public BinaryTreeST(TreeNode root){
        this.root = root;
    }
    ...
    public boolean searchNode(TreeNode root, TreeNode node){
        if (root.getLeftChild().getElement() == node.getElement() || 
                root.getRightChild().getElement() == node.getElement()){
            return true;
        }else{
    ...
    public TreeNode getNode(TreeNode root, TreeNode node){
        if (root != null && root.getElement() == node.getElement()){
            return root;
        }else if (root.getLeftChild() != null && 
                root.getLeftChild().getElement() == node.getElement()){
